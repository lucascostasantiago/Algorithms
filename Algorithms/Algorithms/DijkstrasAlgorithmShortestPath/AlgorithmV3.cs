...
namespace Algorithms.Algorithms.DijkstrasAlgorithmShortestPath
{
    public class AlgorithmV3
    {
        ...
        public static string Run(GraphViewModel vm)
        {
            ...
            var pathAndDistance = $"A distancia do vertice {vm.StartVertex} ao vertice {vm.EndVertex} é de {shortestDistance} e seu caminho é {string.Join(" -> ", shortestPath)}";
